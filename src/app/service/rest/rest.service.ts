...
export class RestService {
  ...
  getUniprotDbCompound(includeParam, page?, perPage?): Observable<any> {
    return this.fetchDataList(`uniprot-compound/?include[]=uniprot_name.*`, includeParam, page, perPage)
      .catch(this.handleError)
  }
